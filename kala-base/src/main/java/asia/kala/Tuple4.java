 ...
 * @author Glavo
 */
public final class Tuple4<T1, T2, T3, T4> extends HList<T1, Tuple3<T2, T3, T4>> implements Serializable {
    ...
    public static <T1, T2, T3, T4> Tuple4<T1, T2, T3, T4> narrow(
            HList<? extends T1, ? extends HList<? extends T2, ? extends HList<? extends T3, ? extends HList<? extends T4, ? extends Tuple0>>>> tuple) {
