 ...
 * @author Glavo
 */
public final class Tuple6<T1, T2, T3, T4, T5, T6> extends HList<T1, Tuple5<T2, T3, T4, T5, T6>> implements Serializable {
    ...
    public static <T1, T2, T3, T4, T5, T6> Tuple6<T1, T2, T3, T4, T5, T6> narrow(
            HList<? extends T1, ? extends HList<? extends T2, ? extends HList<? extends T3, ? extends HList<? extends T4, ? extends HList<? extends T5, ? extends HList<? extends T6, ? extends Tuple0>>>>>> tuple) {
