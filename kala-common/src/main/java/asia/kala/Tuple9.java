 ...
 * @author Glavo
 */
public final class Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends HList<T1, Tuple8<T2, T3, T4, T5, T6, T7, T8, T9>> implements Serializable {
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9> Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> narrow(
            HList<? extends T1, ? extends HList<? extends T2, ? extends HList<? extends T3, ? extends HList<? extends T4, ? extends HList<? extends T5, ? extends HList<? extends T6, ? extends HList<? extends T7, ? extends HList<? extends T8, ? extends HList<? extends T9, ? extends Tuple0>>>>>>>>> tuple) {
