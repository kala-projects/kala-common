 ...
 * @author Glavo
 */
public final class Tuple7<T1, T2, T3, T4, T5, T6, T7> extends HList<T1, Tuple6<T2, T3, T4, T5, T6, T7>> implements Serializable {
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> Tuple7<T1, T2, T3, T4, T5, T6, T7> narrow(
            HList<? extends T1, ? extends HList<? extends T2, ? extends HList<? extends T3, ? extends HList<? extends T4, ? extends HList<? extends T5, ? extends HList<? extends T6, ? extends HList<? extends T7, ? extends Tuple0>>>>>>> tuple) {
