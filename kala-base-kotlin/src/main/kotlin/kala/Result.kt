...
typealias Result<T, E> = asia.kala.control.Result<out T, out E>

typealias Ok<T> = asia.kala.control.Result.Ok<out T, Nothing>
typealias Err<E> = asia.kala.control.Result.Err<Nothing, out E>
